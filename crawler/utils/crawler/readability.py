...
#            print '======================='
#            print self.candidates[url]['score']
#            print self.candidates[url]['node']

            self.candidates[url]['score'] = self.candidates[url]['score'] * \
                                            (1 - self.getLinkDensity(self.candidates[url]['node']))

            if not topCandidate or self.candidates[url]['score'] > topCandidate['score']:
                topCandidate = self.candidates[url]
