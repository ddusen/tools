...
select_risk_keyword  = u"""SELECT id FROM risk_keyword where name in(%s) """

select_risk_news = u"""SELECT count(*) FROM risk_news WHERE (content like %s ) or (title like %s ) and (risk_keyword_id = %s)"""
